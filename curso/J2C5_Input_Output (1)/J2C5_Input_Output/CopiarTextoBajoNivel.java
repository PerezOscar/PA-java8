...
public final class CopiarTextoBajoNivel implements IArchivo { 
    ...
    private FileReader archivoOrigen = null;
    private FileWriter archivoDestino = null;
	...
	try {
            archivoOrigen = new FileReader(objetoFile_archivoOrigen);
            archivoDestino = new FileWriter(objetoFile_archivoDestino);
