...
public final class CopiarBytesBajoNivel implements IArchivo {
    ...
    private FileInputStream archivoOrigen = null;
    private FileOutputStream archivoDestino = null;
	...
	try {
            archivoOrigen = new FileInputStream(objetoFile_archivoOrigen);
            archivoDestino = new FileOutputStream(objetoFile_archivoDestino);
